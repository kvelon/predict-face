...
class Translator(nn.Module):
    def __init__(self, in_channels, hidden_channels, num_translator_stacks, kernel_sizes=[3, 5, 7, 11], groups=8):
        super().__init__()
...
class SimVP(pl.LightningModule):
    def __init__(self, input_shape, hid_s=16, hid_t=256, N_s=4, N_t=8,
                 kernel_sizes=[3,5,7,11], groups=8,
                 learning_rate=1e-3):
        super().__init__()
